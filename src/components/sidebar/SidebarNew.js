            ...
            <div className="sidebar-wrapper">
                ...
                <nav>
                    <ul className="Sidebar_items__1Hqtp">
                        ...
                        <li className="Sidebar_item__rJc2e Sidebar_itemActive__11Rxt">
                            <a className="Sidebar_link__3B0JM"
                ...
                <div className="Sidebar_bottom__3eeR3">
                    <a href="https://pancakeswap.finance/swap#/swap?outputCurrency=0xc34c85a3d7a84212b6234146773f7939a931a8af" target='_blank' rel='noreferrer'>
                        <div className="pancakse-swap">
                            ...
                            <div className='tribe-pancake'>
                                <div className='tribe-small-text'>TRIBE Tokens Available On</div>
                    ...
                    <ul className="Sidebar_media__3EY89">
                        ...
                        <li>
                            <a href="https://instagram.com/tribebsc" target="_blank" rel="noreferrer">
                                <AiFillInstagram className="Sidebar_mediaIcon__2HcGh" />
                            </a>
                        </li>

                        <li>
                            <a href="https://reddit.com/r/tribebsc" target="_blank" rel="noreferrer">
                                <SiReddit className="Sidebar_mediaIcon__2HcGh" />
                            </a>
                        </li>
                        <li>
                            <a href="https://github.com/TribeBSC" target="_blank" rel="noreferrer">
